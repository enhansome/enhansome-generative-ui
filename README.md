...
* [WebArena](https://github.com/web-arena-x/webarena) ⭐ 1,611 | 🐛 103 | 🌐 Python | 📅 2025-11-26 - Realistic web environment and benchmark for agents interacting with live websites.
...
* [Model Context Protocol (MCP) Servers](https://github.com/modelcontextprotocol/servers) ⭐ 90,534 | 🐛 551 | 🌐 TypeScript | 📅 2026-09-03 - Reference implementations of MCP servers and tooling.
* [mcp-ui](https://github.com/idosal/mcp-ui) ⭐ 5,172 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-16 - Ido Salomon and Liad Yosef. Community SDK (TypeScript, Ruby, Python) for serving interactive UI over MCP; pioneered the pattern that fed the official MCP Apps spec.
* [MCP Apps (UI Extension)](https://github.com/modelcontextprotocol/ext-apps) ⭐ 2,862 | 🐛 212 | 🌐 TypeScript | 📅 2026-09-16 - The official MCP extension for interactive UI: tools return UI resources that render in an iframe inside the host client. Builds on mcp-ui and the OpenAI Apps SDK ([announcement](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/)).
...
* [A2UI](https://github.com/google/a2ui) ⭐ 16,464 | 🐛 398 | 🌐 TypeScript | 📅 2026-09-21 - Google. Declarative, streaming (JSONL) generative-UI spec: agents request allow-listed components that the client renders natively (Flutter, Angular, Lit). A data format, not executable code ([site](https://a2ui.org/)).
* [AG-UI (Agent-User Interaction Protocol)](https://github.com/ag-ui-protocol/ag-ui) ⭐ 15,977 | 🐛 378 | 🌐 TypeScript | 📅 2026-09-21 - CopilotKit. Open, event-based protocol that streams agent activity and shared state to front ends over SSE. Adopted by Google, LangChain, AWS, Microsoft, Mastra, and PydanticAI.
...
* [CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,454 | 🐛 274 | 🌐 TypeScript | 📅 2026-09-21 - Full-stack framework for in-app agents and generative UI across React, Angular, mobile, and Slack; makers of the AG-UI protocol.
* [assistant-ui](https://github.com/assistant-ui/assistant-ui) ⭐ 12,244 | 🐛 175 | 🌐 TypeScript | 📅 2026-09-21 - TypeScript/React primitives for AI chat with a first-class generative-UI primitive that renders agent-described components from a consumer-provided allowlist.
* [Tambo](https://github.com/tambo-ai/tambo) ⭐ 11,185 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-21 - Generative UI SDK for React, purpose-built for streaming AI-generated components.
* [OpenUI Lang (Thesys)](https://github.com/thesysdev/openui) ⭐ 9,783 | 🐛 155 | 🌐 TypeScript | 📅 2026-09-21 - MIT-licensed, streaming-first DSL and React runtime for model-generated UI; a compact, token-efficient alternative to emitting component JSON.
* [Hashbrown](https://github.com/liveloveapp/hashbrown) ⭐ 723 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-20 - Framework for building generative user interfaces in Angular and React.
...
* [Mitosis](https://github.com/BuilderIO/mitosis) ⭐ 14,404 | 🐛 176 | 🌐 TypeScript | 📅 2026-07-21 - Builder.io. Write components once and compile to React/Vue/Svelte/etc.
* [Instructor](https://github.com/jxnl/instructor) ⭐ 13,933 | 🐛 75 | 🌐 Python | 📅 2026-09-18 - Structured output extraction; useful with UI schemas for reliable generation.
...
* [Cofounder](https://github.com/raidendotai/cofounder) ⭐ 6,654 | 🐛 68 | 🌐 TypeScript | 📅 2024-11-08 - Open source full-stack app generator with generative UI, databases, and APIs.
...
* [Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 79,485 | 🐛 146 | 🌐 Python | 📅 2026-09-09 - Convert screenshots or designs to HTML/React/Vue code.
...
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 37,446 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-18 - Microsoft. MCP server for browser automation and UI regression testing workflows.
* [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 15,890 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-18 - GLips. Provides Figma layout information to AI coding agents.
* [Cursor Talk to Figma MCP](https://github.com/grab/cursor-talk-to-figma-mcp) ⭐ 7,031 | 🐛 88 | 🌐 JavaScript | 📅 2026-07-26 - Grab. MCP server + Figma plugin for reading and modifying Figma designs.
* [21st.dev Magic MCP](https://github.com/21st-dev/magic-mcp) ⭐ 5,909 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-09 - 21st.dev. Generate UI components from prompts with design-system awareness.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,409 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-19 - Widely used HTML sanitizer for untrusted/generated markup.
* [E2B](https://github.com/e2b-dev/e2b) ⭐ 13,903 | 🐛 72 | 🌐 Python | 📅 2026-09-21 - Sandboxed code execution environments for running untrusted generated code.
* [Sandpack](https://github.com/codesandbox/sandpack) ⭐ 6,243 | 🐛 163 | 🌐 TypeScript | 📅 2025-04-24 - CodeSandbox. In-browser code sandboxing patterns for safe previews.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,341 | 🐛 629 | 🌐 TypeScript | 📅 2026-09-21 - Prompt and tool-call regression testing across models.
* [garak](https://github.com/NVIDIA/garak) ⭐ 9,326 | 🐛 452 | 🌐 Python | 📅 2026-09-16 - NVIDIA. LLM vulnerability scanner for automated probing.
...
* [Zod](https://github.com/colinhacks/zod) ⭐ 43,985 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-21 - Colin Hacks. TypeScript schema validation for enforcing output shapes at runtime.
* [Guidance](https://github.com/guidance-ai/guidance) ⭐ 21,770 | 🐛 332 | 🌐 Jupyter Notebook | 📅 2026-05-21 - Grammar- and constraint-oriented prompting for structured outputs.
* [Outlines](https://github.com/dottxt-ai/outlines) ⭐ 15,865 | 🐛 173 | 🌐 Python | 📅 2026-09-21 - Structured generation with JSON/grammar constraints.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 3,015 | 🐛 2 | 🌐 Vue | 📅 2026-09-21 - Multi-framework streaming Markdown components for AI chat, with Mermaid, KaTeX, code highlighting, safe HTML, and SSR support.
...
* [ai-chatbot](https://github.com/vercel/ai-chatbot) ⭐ 20,963 | 🐛 28 | 🌐 TypeScript | 📅 2026-07-08 - Vercel. Full-featured chatbot with generative UI using the AI SDK.
* [morphic](https://github.com/miurla/morphic) ⭐ 9,134 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-21 - AI-powered search engine with generative answer UI.
...
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,488 | 🐛 340 | 🌐 Python | 📅 2026-04-14 - OpenAI. Framework for evaluating model outputs with custom tasks and graders.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,570 | 🐛 72 | 🌐 Python | 📅 2026-09-21 - TruEra. Evaluation and feedback tooling for LLM applications.
