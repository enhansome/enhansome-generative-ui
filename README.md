...
* [Model Context Protocol (MCP) Servers](https://github.com/modelcontextprotocol/servers) ⭐ 89,940 | 🐛 506 | 🌐 TypeScript | 📅 2026-08-28 - Reference implementations of MCP servers and tooling.
...
* [MCP Apps (UI Extension)](https://github.com/modelcontextprotocol/ext-apps) ⭐ 2,770 | 🐛 208 | 🌐 TypeScript | 📅 2026-08-12 - The official MCP extension for interactive UI: tools return UI resources that render in an iframe inside the host client. Builds on mcp-ui and the OpenAI Apps SDK ([announcement](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/)).
...
* [A2UI](https://github.com/google/a2ui) ⭐ 16,229 | 🐛 350 | 🌐 TypeScript | 📅 2026-08-29 - Google. Declarative, streaming (JSONL) generative-UI spec: agents request allow-listed components that the client renders natively (Flutter, Angular, Lit). A data format, not executable code ([site](https://a2ui.org/)).
* [AG-UI (Agent-User Interaction Protocol)](https://github.com/ag-ui-protocol/ag-ui) ⭐ 15,607 | 🐛 333 | 🌐 Python | 📅 2026-08-28 - CopilotKit. Open, event-based protocol that streams agent activity and shared state to front ends over SSE. Adopted by Google, LangChain, AWS, Microsoft, Mastra, and PydanticAI.
...
* [CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,094 | 🐛 364 | 🌐 TypeScript | 📅 2026-08-29 - Full-stack framework for in-app agents and generative UI across React, Angular, mobile, and Slack; makers of the AG-UI protocol.
* [assistant-ui](https://github.com/assistant-ui/assistant-ui) ⭐ 11,908 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-29 - TypeScript/React primitives for AI chat with a first-class generative-UI primitive that renders agent-described components from a consumer-provided allowlist.
...
* [OpenUI Lang (Thesys)](https://github.com/thesysdev/openui) ⭐ 8,481 | 🐛 144 | 🌐 TypeScript | 📅 2026-08-28 - MIT-licensed, streaming-first DSL and React runtime for model-generated UI; a compact, token-efficient alternative to emitting component JSON.
...
* [Instructor](https://github.com/jxnl/instructor) ⭐ 13,795 | 🐛 39 | 🌐 Python | 📅 2026-08-29 - Structured output extraction; useful with UI schemas for reliable generation.
...
* [Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 75,646 | 🐛 131 | 🌐 Python | 📅 2026-08-14 - Convert screenshots or designs to HTML/React/Vue code.
...
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,592 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-28 - Microsoft. MCP server for browser automation and UI regression testing workflows.
* [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 15,731 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-07 - GLips. Provides Figma layout information to AI coding agents.
...
* [21st.dev Magic MCP](https://github.com/21st-dev/magic-mcp) ⭐ 5,747 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-31 - 21st.dev. Generate UI components from prompts with design-system awareness.
...
* [E2B](https://github.com/e2b-dev/e2b) ⭐ 13,577 | 🐛 47 | 🌐 Python | 📅 2026-08-28 - Sandboxed code execution environments for running untrusted generated code.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,651 | 🐛 540 | 🌐 TypeScript | 📅 2026-08-29 - Prompt and tool-call regression testing across models.
...
* [Outlines](https://github.com/dottxt-ai/outlines) ⭐ 15,710 | 🐛 163 | 🌐 Python | 📅 2026-08-28 - Structured generation with JSON/grammar constraints.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,969 | 🐛 2 | 🌐 Vue | 📅 2026-08-28 - Multi-framework streaming Markdown components for AI chat, with Mermaid, KaTeX, code highlighting, safe HTML, and SSR support.
...
* [TruLens](https://github.com/truera/trulens) ⭐ 3,526 | 🐛 61 | 🌐 Python | 📅 2026-08-28 - TruEra. Evaluation and feedback tooling for LLM applications.
