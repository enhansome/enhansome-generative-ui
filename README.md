...
* [WebArena](https://github.com/web-arena-x/webarena) ⭐ 1,589 | 🐛 101 | 🌐 Python | 📅 2025-11-26 - Realistic web environment and benchmark for agents interacting with live websites.
...
* [Model Context Protocol (MCP) Servers](https://github.com/modelcontextprotocol/servers) ⭐ 89,905 | 🐛 550 | 🌐 TypeScript | 📅 2026-08-20 - Reference implementations of MCP servers and tooling.
* [mcp-ui](https://github.com/idosal/mcp-ui) ⭐ 5,110 | 🐛 60 | 🌐 TypeScript | 📅 2026-07-08 - Ido Salomon and Liad Yosef. Community SDK (TypeScript, Ruby, Python) for serving interactive UI over MCP; pioneered the pattern that fed the official MCP Apps spec.
* [MCP Apps (UI Extension)](https://github.com/modelcontextprotocol/ext-apps) ⭐ 2,764 | 🐛 206 | 🌐 TypeScript | 📅 2026-08-12 - The official MCP extension for interactive UI: tools return UI resources that render in an iframe inside the host client. Builds on mcp-ui and the OpenAI Apps SDK ([announcement](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/)).
...
* [A2UI](https://github.com/google/a2ui) ⭐ 16,214 | 🐛 339 | 🌐 TypeScript | 📅 2026-08-27 - Google. Declarative, streaming (JSONL) generative-UI spec: agents request allow-listed components that the client renders natively (Flutter, Angular, Lit). A data format, not executable code ([site](https://a2ui.org/)).
* [AG-UI (Agent-User Interaction Protocol)](https://github.com/ag-ui-protocol/ag-ui) ⭐ 15,571 | 🐛 337 | 🌐 Python | 📅 2026-08-27 - CopilotKit. Open, event-based protocol that streams agent activity and shared state to front ends over SSE. Adopted by Google, LangChain, AWS, Microsoft, Mastra, and PydanticAI.
...
* [CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,068 | 🐛 366 | 🌐 TypeScript | 📅 2026-08-27 - Full-stack framework for in-app agents and generative UI across React, Angular, mobile, and Slack; makers of the AG-UI protocol.
* [assistant-ui](https://github.com/assistant-ui/assistant-ui) ⭐ 11,876 | 🐛 79 | 🌐 TypeScript | 📅 2026-08-27 - TypeScript/React primitives for AI chat with a first-class generative-UI primitive that renders agent-described components from a consumer-provided allowlist.
* [Tambo](https://github.com/tambo-ai/tambo) ⭐ 11,170 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-27 - Generative UI SDK for React, purpose-built for streaming AI-generated components.
* [OpenUI Lang (Thesys)](https://github.com/thesysdev/openui) ⭐ 8,469 | 🐛 141 | 🌐 TypeScript | 📅 2026-08-27 - MIT-licensed, streaming-first DSL and React runtime for model-generated UI; a compact, token-efficient alternative to emitting component JSON.
...
* [Instructor](https://github.com/jxnl/instructor) ⭐ 13,786 | 🐛 52 | 🌐 Python | 📅 2026-08-09 - Structured output extraction; useful with UI schemas for reliable generation.
...
* [OpenUI (Weights & Biases)](https://github.com/wandb/openui) ⭐ 22,519 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-27 - Describe UI in natural language and see it rendered live.
...
* [Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 74,933 | 🐛 130 | 🌐 Python | 📅 2026-08-14 - Convert screenshots or designs to HTML/React/Vue code.
...
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,521 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-21 - Microsoft. MCP server for browser automation and UI regression testing workflows.
* [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 15,723 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-07 - GLips. Provides Figma layout information to AI coding agents.
...
* [21st.dev Magic MCP](https://github.com/21st-dev/magic-mcp) ⭐ 5,734 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-31 - 21st.dev. Generate UI components from prompts with design-system awareness.
* [shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,961 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-16 - Jpisnice. Helps LLMs understand shadcn/ui component structure.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,343 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-24 - Widely used HTML sanitizer for untrusted/generated markup.
* [E2B](https://github.com/e2b-dev/e2b) ⭐ 13,563 | 🐛 44 | 🌐 Python | 📅 2026-08-27 - Sandboxed code execution environments for running untrusted generated code.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,617 | 🐛 530 | 🌐 TypeScript | 📅 2026-08-27 - Prompt and tool-call regression testing across models.
* [garak](https://github.com/NVIDIA/garak) ⭐ 9,041 | 🐛 403 | 🌐 Python | 📅 2026-08-25 - NVIDIA. LLM vulnerability scanner for automated probing.
...
* [Zod](https://github.com/colinhacks/zod) ⭐ 43,538 | 🐛 78 | 🌐 TypeScript | 📅 2026-08-27 - Colin Hacks. TypeScript schema validation for enforcing output shapes at runtime.
...
* [Outlines](https://github.com/dottxt-ai/outlines) ⭐ 15,701 | 🐛 164 | 🌐 Python | 📅 2026-08-27 - Structured generation with JSON/grammar constraints.
...
* [ai-chatbot](https://github.com/vercel/ai-chatbot) ⭐ 20,878 | 🐛 28 | 🌐 TypeScript | 📅 2026-07-08 - Vercel. Full-featured chatbot with generative UI using the AI SDK.
* [morphic](https://github.com/miurla/morphic) ⭐ 9,067 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-26 - AI-powered search engine with generative answer UI.
...
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,282 | 🐛 324 | 🌐 Python | 📅 2026-04-14 - OpenAI. Framework for evaluating model outputs with custom tasks and graders.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,525 | 🐛 63 | 🌐 Python | 📅 2026-08-27 - TruEra. Evaluation and feedback tooling for LLM applications.
