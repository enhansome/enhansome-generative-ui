...
* [WebArena](https://github.com/web-arena-x/webarena) ⭐ 1,577 | 🐛 100 | 🌐 Python | 📅 2025-11-26 - Realistic web environment and benchmark for agents interacting with live websites.
* [Mind2Web](https://github.com/OSU-NLP-Group/Mind2Web) ⭐ 1,019 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2025-11-05 - Dataset and benchmark for generalist web agents grounded in real webpages.
...
* [MiniWoB++](https://github.com/Farama-Foundation/miniwob-plusplus) ⭐ 396 | 🐛 3 | 🌐 HTML | 📅 2026-08-13 - Standard suite of web UI interaction tasks used for agent evaluation.
...
* [Model Context Protocol (MCP) Servers](https://github.com/modelcontextprotocol/servers) ⭐ 89,561 | 🐛 510 | 🌐 TypeScript | 📅 2026-08-10 - Reference implementations of MCP servers and tooling.
* [mcp-ui](https://github.com/idosal/mcp-ui) ⭐ 5,087 | 🐛 59 | 🌐 TypeScript | 📅 2026-07-08 - Ido Salomon and Liad Yosef. Community SDK (TypeScript, Ruby, Python) for serving interactive UI over MCP; pioneered the pattern that fed the official MCP Apps spec.
* [MCP Apps (UI Extension)](https://github.com/modelcontextprotocol/ext-apps) ⭐ 2,718 | 🐛 193 | 🌐 TypeScript | 📅 2026-08-12 - The official MCP extension for interactive UI: tools return UI resources that render in an iframe inside the host client. Builds on mcp-ui and the OpenAI Apps SDK ([announcement](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/)).
...
* [A2UI](https://github.com/google/a2ui) ⭐ 16,115 | 🐛 303 | 🌐 TypeScript | 📅 2026-08-14 - Google. Declarative, streaming (JSONL) generative-UI spec: agents request allow-listed components that the client renders natively (Flutter, Angular, Lit). A data format, not executable code ([site](https://a2ui.org/)).
* [AG-UI (Agent-User Interaction Protocol)](https://github.com/ag-ui-protocol/ag-ui) ⭐ 15,315 | 🐛 326 | 🌐 Python | 📅 2026-08-14 - CopilotKit. Open, event-based protocol that streams agent activity and shared state to front ends over SSE. Adopted by Google, LangChain, AWS, Microsoft, Mastra, and PydanticAI.
...
* [CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 36,761 | 🐛 340 | 🌐 TypeScript | 📅 2026-08-14 - Full-stack framework for in-app agents and generative UI across React, Angular, mobile, and Slack; makers of the AG-UI protocol.
* [assistant-ui](https://github.com/assistant-ui/assistant-ui) ⭐ 11,653 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-14 - TypeScript/React primitives for AI chat with a first-class generative-UI primitive that renders agent-described components from a consumer-provided allowlist.
* [Tambo](https://github.com/tambo-ai/tambo) ⭐ 11,164 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-12 - Generative UI SDK for React, purpose-built for streaming AI-generated components.
* [OpenUI Lang (Thesys)](https://github.com/thesysdev/openui) ⭐ 8,363 | 🐛 142 | 🌐 TypeScript | 📅 2026-08-14 - MIT-licensed, streaming-first DSL and React runtime for model-generated UI; a compact, token-efficient alternative to emitting component JSON.
* [Hashbrown](https://github.com/liveloveapp/hashbrown) ⭐ 718 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-10 - Framework for building generative user interfaces in Angular and React.
...
* [Mitosis](https://github.com/BuilderIO/mitosis) ⭐ 13,899 | 🐛 173 | 🌐 TypeScript | 📅 2026-07-21 - Builder.io. Write components once and compile to React/Vue/Svelte/etc.
* [Instructor](https://github.com/jxnl/instructor) ⭐ 13,730 | 🐛 35 | 🌐 Python | 📅 2026-08-09 - Structured output extraction; useful with UI schemas for reliable generation.
...
* [OpenUI (Weights & Biases)](https://github.com/wandb/openui) ⭐ 22,504 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-14 - Describe UI in natural language and see it rendered live.
* [openv0](https://github.com/raidendotai/openv0) ⭐ 3,950 | 🐛 35 | 🌐 TypeScript | 📅 2024-09-19 - Open source v0 clone that generates React/Tailwind components from prompts.
...
* [Cofounder](https://github.com/raidendotai/cofounder) ⭐ 6,658 | 🐛 68 | 🌐 TypeScript | 📅 2024-11-08 - Open source full-stack app generator with generative UI, databases, and APIs.

### Design-to-Code

*"Convert visuals to working code."*

* [Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 74,023 | 🐛 126 | 🌐 Python | 📅 2026-08-14 - Convert screenshots or designs to HTML/React/Vue code.
...
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,125 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-12 - Microsoft. MCP server for browser automation and UI regression testing workflows.
* [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 15,658 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-07 - GLips. Provides Figma layout information to AI coding agents.
* [Cursor Talk to Figma MCP](https://github.com/grab/cursor-talk-to-figma-mcp) ⭐ 6,967 | 🐛 87 | 🌐 JavaScript | 📅 2026-07-26 - Grab. MCP server + Figma plugin for reading and modifying Figma designs.
* [21st.dev Magic MCP](https://github.com/21st-dev/magic-mcp) ⭐ 5,660 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-31 - 21st.dev. Generate UI components from prompts with design-system awareness.
* [shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,932 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-16 - Jpisnice. Helps LLMs understand shadcn/ui component structure.
* [Storybook MCP](https://github.com/storybookjs/mcp) ⭐ 266 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-14 - Storybook. MCP server and addon that exposes component information and workflows from your local Storybook ([npm](https://www.npmjs.com/package/@storybook/mcp)).
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,302 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-14 - Widely used HTML sanitizer for untrusted/generated markup.
* [E2B](https://github.com/e2b-dev/e2b) ⭐ 13,404 | 🐛 41 | 🌐 Python | 📅 2026-08-13 - Sandboxed code execution environments for running untrusted generated code.
* [Sandpack](https://github.com/codesandbox/sandpack) ⭐ 6,209 | 🐛 159 | 🌐 TypeScript | 📅 2025-04-24 - CodeSandbox. In-browser code sandboxing patterns for safe previews.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,235 | 🐛 497 | 🌐 TypeScript | 📅 2026-08-14 - Prompt and tool-call regression testing across models.
* [garak](https://github.com/NVIDIA/garak) ⭐ 8,800 | 🐛 390 | 🌐 Python | 📅 2026-08-13 - NVIDIA. LLM vulnerability scanner for automated probing.
...
* [Zod](https://github.com/colinhacks/zod) ⭐ 43,460 | 🐛 191 | 🌐 TypeScript | 📅 2026-08-14 - Colin Hacks. TypeScript schema validation for enforcing output shapes at runtime.
* [Guidance](https://github.com/guidance-ai/guidance) ⭐ 21,713 | 🐛 317 | 🌐 Jupyter Notebook | 📅 2026-05-21 - Grammar- and constraint-oriented prompting for structured outputs.
* [Outlines](https://github.com/dottxt-ai/outlines) ⭐ 15,615 | 🐛 146 | 🌐 Python | 📅 2026-08-14 - Structured generation with JSON/grammar constraints.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,883 | 🐛 0 | 🌐 Vue | 📅 2026-08-14 - Multi-framework streaming Markdown components for AI chat, with Mermaid, KaTeX, code highlighting, safe HTML, and SSR support.
* [GPT-Vis](https://github.com/antvis/GPT-Vis) ⭐ 766 | 🐛 4 | 🌐 TypeScript | 📅 2026-06-26 - AntV. Visualization components designed for LLM-generated outputs.
...
* [ai-chatbot](https://github.com/vercel/ai-chatbot) ⭐ 20,822 | 🐛 24 | 🌐 TypeScript | 📅 2026-07-08 - Vercel. Full-featured chatbot with generative UI using the AI SDK.
* [morphic](https://github.com/miurla/morphic) ⭐ 9,039 | 🐛 54 | 🌐 TypeScript | 📅 2026-08-14 - AI-powered search engine with generative answer UI.
* [termite](https://github.com/shobrook/termite) ⭐ 418 | 🐛 7 | 🌐 Python | 📅 2025-01-06 - Terminal-based generative UI.
...
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,171 | 🐛 225 | 🌐 Python | 📅 2026-04-14 - OpenAI. Framework for evaluating model outputs with custom tasks and graders.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,508 | 🐛 42 | 🌐 Python | 📅 2026-08-14 - TruEra. Evaluation and feedback tooling for LLM applications.
