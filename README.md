...
* [Model Context Protocol (MCP) Servers](https://github.com/modelcontextprotocol/servers) ⭐ 90,165 | 🐛 501 | 🌐 TypeScript | 📅 2026-09-03 - Reference implementations of MCP servers and tooling.
* [mcp-ui](https://github.com/idosal/mcp-ui) ⭐ 5,130 | 🐛 62 | 🌐 TypeScript | 📅 2026-07-08 - Ido Salomon and Liad Yosef. Community SDK (TypeScript, Ruby, Python) for serving interactive UI over MCP; pioneered the pattern that fed the official MCP Apps spec.
* [MCP Apps (UI Extension)](https://github.com/modelcontextprotocol/ext-apps) ⭐ 2,805 | 🐛 207 | 🌐 TypeScript | 📅 2026-09-08 - The official MCP extension for interactive UI: tools return UI resources that render in an iframe inside the host client. Builds on mcp-ui and the OpenAI Apps SDK ([announcement](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/)).
...
* [A2UI](https://github.com/google/a2ui) ⭐ 16,320 | 🐛 371 | 🌐 TypeScript | 📅 2026-09-08 - Google. Declarative, streaming (JSONL) generative-UI spec: agents request allow-listed components that the client renders natively (Flutter, Angular, Lit). A data format, not executable code ([site](https://a2ui.org/)).
* [AG-UI (Agent-User Interaction Protocol)](https://github.com/ag-ui-protocol/ag-ui) ⭐ 15,793 | 🐛 360 | 🌐 Python | 📅 2026-09-08 - CopilotKit. Open, event-based protocol that streams agent activity and shared state to front ends over SSE. Adopted by Google, LangChain, AWS, Microsoft, Mastra, and PydanticAI.
...
* [CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,256 | 🐛 295 | 🌐 TypeScript | 📅 2026-09-08 - Full-stack framework for in-app agents and generative UI across React, Angular, mobile, and Slack; makers of the AG-UI protocol.
* [assistant-ui](https://github.com/assistant-ui/assistant-ui) ⭐ 12,055 | 🐛 101 | 🌐 TypeScript | 📅 2026-09-08 - TypeScript/React primitives for AI chat with a first-class generative-UI primitive that renders agent-described components from a consumer-provided allowlist.
* [Tambo](https://github.com/tambo-ai/tambo) ⭐ 11,176 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-07 - Generative UI SDK for React, purpose-built for streaming AI-generated components.
* [OpenUI Lang (Thesys)](https://github.com/thesysdev/openui) ⭐ 8,629 | 🐛 151 | 🌐 TypeScript | 📅 2026-09-08 - MIT-licensed, streaming-first DSL and React runtime for model-generated UI; a compact, token-efficient alternative to emitting component JSON.
...
* [Mitosis](https://github.com/BuilderIO/mitosis) ⭐ 14,365 | 🐛 176 | 🌐 TypeScript | 📅 2026-07-21 - Builder.io. Write components once and compile to React/Vue/Svelte/etc.
* [Instructor](https://github.com/jxnl/instructor) ⭐ 13,842 | 🐛 47 | 🌐 Python | 📅 2026-09-07 - Structured output extraction; useful with UI schemas for reliable generation.
...
* [OpenUI (Weights & Biases)](https://github.com/wandb/openui) ⭐ 22,538 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-27 - Describe UI in natural language and see it rendered live.
...
* [Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 78,295 | 🐛 143 | 🌐 Python | 📅 2026-08-14 - Convert screenshots or designs to HTML/React/Vue code.
...
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,898 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-04 - Microsoft. MCP server for browser automation and UI regression testing workflows.
* [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 15,803 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-07 - GLips. Provides Figma layout information to AI coding agents.
* [Cursor Talk to Figma MCP](https://github.com/grab/cursor-talk-to-figma-mcp) ⭐ 6,996 | 🐛 88 | 🌐 JavaScript | 📅 2026-07-26 - Grab. MCP server + Figma plugin for reading and modifying Figma designs.
* [21st.dev Magic MCP](https://github.com/21st-dev/magic-mcp) ⭐ 5,828 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-01 - 21st.dev. Generate UI components from prompts with design-system awareness.
* [shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,978 | 🐛 4 | 🌐 TypeScript | 📅 2026-05-16 - Jpisnice. Helps LLMs understand shadcn/ui component structure.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,369 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-06 - Widely used HTML sanitizer for untrusted/generated markup.
* [E2B](https://github.com/e2b-dev/e2b) ⭐ 13,711 | 🐛 69 | 🌐 Python | 📅 2026-09-08 - Sandboxed code execution environments for running untrusted generated code.
* [Sandpack](https://github.com/codesandbox/sandpack) ⭐ 6,231 | 🐛 162 | 🌐 TypeScript | 📅 2025-04-24 - CodeSandbox. In-browser code sandboxing patterns for safe previews.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,934 | 🐛 623 | 🌐 TypeScript | 📅 2026-09-08 - Prompt and tool-call regression testing across models.
* [garak](https://github.com/NVIDIA/garak) ⭐ 9,144 | 🐛 421 | 🌐 Python | 📅 2026-09-04 - NVIDIA. LLM vulnerability scanner for automated probing.
...
* [Zod](https://github.com/colinhacks/zod) ⭐ 43,912 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-08 - Colin Hacks. TypeScript schema validation for enforcing output shapes at runtime.
* [Guidance](https://github.com/guidance-ai/guidance) ⭐ 21,741 | 🐛 323 | 🌐 Jupyter Notebook | 📅 2026-05-21 - Grammar- and constraint-oriented prompting for structured outputs.
* [Outlines](https://github.com/dottxt-ai/outlines) ⭐ 15,762 | 🐛 159 | 🌐 Python | 📅 2026-09-04 - Structured generation with JSON/grammar constraints.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,996 | 🐛 0 | 🌐 Vue | 📅 2026-09-08 - Multi-framework streaming Markdown components for AI chat, with Mermaid, KaTeX, code highlighting, safe HTML, and SSR support.
...
* [ai-chatbot](https://github.com/vercel/ai-chatbot) ⭐ 20,927 | 🐛 28 | 🌐 TypeScript | 📅 2026-07-08 - Vercel. Full-featured chatbot with generative UI using the AI SDK.
* [morphic](https://github.com/miurla/morphic) ⭐ 9,095 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-08 - AI-powered search engine with generative answer UI.
...
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,412 | 🐛 334 | 🌐 Python | 📅 2026-04-14 - OpenAI. Framework for evaluating model outputs with custom tasks and graders.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,540 | 🐛 59 | 🌐 Python | 📅 2026-09-08 - TruEra. Evaluation and feedback tooling for LLM applications.
