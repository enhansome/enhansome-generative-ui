...
* [WebArena](https://github.com/web-arena-x/webarena) ⭐ 1,590 | 🐛 102 | 🌐 Python | 📅 2025-11-26 - Realistic web environment and benchmark for agents interacting with live websites.
* [Mind2Web](https://github.com/OSU-NLP-Group/Mind2Web) ⭐ 1,022 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2025-11-05 - Dataset and benchmark for generalist web agents grounded in real webpages.
...
* [Model Context Protocol (MCP) Servers](https://github.com/modelcontextprotocol/servers) ⭐ 89,992 | 🐛 513 | 🌐 TypeScript | 📅 2026-08-31 - Reference implementations of MCP servers and tooling.
* [mcp-ui](https://github.com/idosal/mcp-ui) ⭐ 5,117 | 🐛 60 | 🌐 TypeScript | 📅 2026-07-08 - Ido Salomon and Liad Yosef. Community SDK (TypeScript, Ruby, Python) for serving interactive UI over MCP; pioneered the pattern that fed the official MCP Apps spec.
* [MCP Apps (UI Extension)](https://github.com/modelcontextprotocol/ext-apps) ⭐ 2,776 | 🐛 209 | 🌐 TypeScript | 📅 2026-08-12 - The official MCP extension for interactive UI: tools return UI resources that render in an iframe inside the host client. Builds on mcp-ui and the OpenAI Apps SDK ([announcement](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/)).
...
* [A2UI](https://github.com/google/a2ui) ⭐ 16,243 | 🐛 355 | 🌐 TypeScript | 📅 2026-08-31 - Google. Declarative, streaming (JSONL) generative-UI spec: agents request allow-listed components that the client renders natively (Flutter, Angular, Lit). A data format, not executable code ([site](https://a2ui.org/)).
* [AG-UI (Agent-User Interaction Protocol)](https://github.com/ag-ui-protocol/ag-ui) ⭐ 15,652 | 🐛 336 | 🌐 Python | 📅 2026-08-31 - CopilotKit. Open, event-based protocol that streams agent activity and shared state to front ends over SSE. Adopted by Google, LangChain, AWS, Microsoft, Mastra, and PydanticAI.
...
* [CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,132 | 🐛 310 | 🌐 TypeScript | 📅 2026-08-31 - Full-stack framework for in-app agents and generative UI across React, Angular, mobile, and Slack; makers of the AG-UI protocol.
* [assistant-ui](https://github.com/assistant-ui/assistant-ui) ⭐ 11,955 | 🐛 104 | 🌐 TypeScript | 📅 2026-08-31 - TypeScript/React primitives for AI chat with a first-class generative-UI primitive that renders agent-described components from a consumer-provided allowlist.
* [Tambo](https://github.com/tambo-ai/tambo) ⭐ 11,168 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-31 - Generative UI SDK for React, purpose-built for streaming AI-generated components.
* [OpenUI Lang (Thesys)](https://github.com/thesysdev/openui) ⭐ 8,496 | 🐛 150 | 🌐 TypeScript | 📅 2026-08-31 - MIT-licensed, streaming-first DSL and React runtime for model-generated UI; a compact, token-efficient alternative to emitting component JSON.
* [Hashbrown](https://github.com/liveloveapp/hashbrown) ⭐ 719 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-31 - Framework for building generative user interfaces in Angular and React.
...
* [Mitosis](https://github.com/BuilderIO/mitosis) ⭐ 13,966 | 🐛 176 | 🌐 TypeScript | 📅 2026-07-21 - Builder.io. Write components once and compile to React/Vue/Svelte/etc.
* [Instructor](https://github.com/jxnl/instructor) ⭐ 13,812 | 🐛 40 | 🌐 Python | 📅 2026-08-31 - Structured output extraction; useful with UI schemas for reliable generation.
...
* [OpenUI (Weights & Biases)](https://github.com/wandb/openui) ⭐ 22,524 | 🐛 88 | 🌐 TypeScript | 📅 2026-08-27 - Describe UI in natural language and see it rendered live.
...
* [Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 76,696 | 🐛 134 | 🌐 Python | 📅 2026-08-14 - Convert screenshots or designs to HTML/React/Vue code.
...
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,668 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-28 - Microsoft. MCP server for browser automation and UI regression testing workflows.
* [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 15,746 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-07 - GLips. Provides Figma layout information to AI coding agents.
...
* [21st.dev Magic MCP](https://github.com/21st-dev/magic-mcp) ⭐ 5,764 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31 - 21st.dev. Generate UI components from prompts with design-system awareness.
* [shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,969 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-16 - Jpisnice. Helps LLMs understand shadcn/ui component structure.
* [Storybook MCP](https://github.com/storybookjs/mcp) ⭐ 270 | 🐛 48 | 🌐 TypeScript | 📅 2026-08-31 - Storybook. MCP server and addon that exposes component information and workflows from your local Storybook ([npm](https://www.npmjs.com/package/@storybook/mcp)).
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,350 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-29 - Widely used HTML sanitizer for untrusted/generated markup.
* [E2B](https://github.com/e2b-dev/e2b) ⭐ 13,606 | 🐛 48 | 🌐 Python | 📅 2026-08-31 - Sandboxed code execution environments for running untrusted generated code.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,706 | 🐛 567 | 🌐 TypeScript | 📅 2026-08-31 - Prompt and tool-call regression testing across models.
* [garak](https://github.com/NVIDIA/garak) ⭐ 9,083 | 🐛 412 | 🌐 Python | 📅 2026-08-25 - NVIDIA. LLM vulnerability scanner for automated probing.
...
* [Zod](https://github.com/colinhacks/zod) ⭐ 43,730 | 🐛 70 | 🌐 TypeScript | 📅 2026-08-31 - Colin Hacks. TypeScript schema validation for enforcing output shapes at runtime.
* [Guidance](https://github.com/guidance-ai/guidance) ⭐ 21,729 | 🐛 323 | 🌐 Jupyter Notebook | 📅 2026-05-21 - Grammar- and constraint-oriented prompting for structured outputs.
* [Outlines](https://github.com/dottxt-ai/outlines) ⭐ 15,727 | 🐛 161 | 🌐 Python | 📅 2026-08-31 - Structured generation with JSON/grammar constraints.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,977 | 🐛 2 | 🌐 Vue | 📅 2026-08-31 - Multi-framework streaming Markdown components for AI chat, with Mermaid, KaTeX, code highlighting, safe HTML, and SSR support.
...
* [ai-chatbot](https://github.com/vercel/ai-chatbot) ⭐ 20,894 | 🐛 28 | 🌐 TypeScript | 📅 2026-07-08 - Vercel. Full-featured chatbot with generative UI using the AI SDK.
* [morphic](https://github.com/miurla/morphic) ⭐ 9,077 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-29 - AI-powered search engine with generative answer UI.
...
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,346 | 🐛 327 | 🌐 Python | 📅 2026-04-14 - OpenAI. Framework for evaluating model outputs with custom tasks and graders.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,531 | 🐛 66 | 🌐 Python | 📅 2026-08-31 - TruEra. Evaluation and feedback tooling for LLM applications.
