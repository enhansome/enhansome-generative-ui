...
* [Model Context Protocol (MCP) Servers](https://github.com/modelcontextprotocol/servers) ⭐ 89,587 | 🐛 512 | 🌐 TypeScript | 📅 2026-08-10 - Reference implementations of MCP servers and tooling.
* [mcp-ui](https://github.com/idosal/mcp-ui) ⭐ 5,089 | 🐛 59 | 🌐 TypeScript | 📅 2026-07-08 - Ido Salomon and Liad Yosef. Community SDK (TypeScript, Ruby, Python) for serving interactive UI over MCP; pioneered the pattern that fed the official MCP Apps spec.
* [MCP Apps (UI Extension)](https://github.com/modelcontextprotocol/ext-apps) ⭐ 2,724 | 🐛 195 | 🌐 TypeScript | 📅 2026-08-12 - The official MCP extension for interactive UI: tools return UI resources that render in an iframe inside the host client. Builds on mcp-ui and the OpenAI Apps SDK ([announcement](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/)).
...
* [A2UI](https://github.com/google/a2ui) ⭐ 16,117 | 🐛 307 | 🌐 TypeScript | 📅 2026-08-15 - Google. Declarative, streaming (JSONL) generative-UI spec: agents request allow-listed components that the client renders natively (Flutter, Angular, Lit). A data format, not executable code ([site](https://a2ui.org/)).
* [AG-UI (Agent-User Interaction Protocol)](https://github.com/ag-ui-protocol/ag-ui) ⭐ 15,326 | 🐛 322 | 🌐 Python | 📅 2026-08-15 - CopilotKit. Open, event-based protocol that streams agent activity and shared state to front ends over SSE. Adopted by Google, LangChain, AWS, Microsoft, Mastra, and PydanticAI.
...
* [CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 36,782 | 🐛 342 | 🌐 TypeScript | 📅 2026-08-15 - Full-stack framework for in-app agents and generative UI across React, Angular, mobile, and Slack; makers of the AG-UI protocol.
* [assistant-ui](https://github.com/assistant-ui/assistant-ui) ⭐ 11,672 | 🐛 94 | 🌐 TypeScript | 📅 2026-08-15 - TypeScript/React primitives for AI chat with a first-class generative-UI primitive that renders agent-described components from a consumer-provided allowlist.
* [Tambo](https://github.com/tambo-ai/tambo) ⭐ 11,164 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-15 - Generative UI SDK for React, purpose-built for streaming AI-generated components.
* [OpenUI Lang (Thesys)](https://github.com/thesysdev/openui) ⭐ 8,373 | 🐛 142 | 🌐 TypeScript | 📅 2026-08-15 - MIT-licensed, streaming-first DSL and React runtime for model-generated UI; a compact, token-efficient alternative to emitting component JSON.
...
* [Instructor](https://github.com/jxnl/instructor) ⭐ 13,733 | 🐛 35 | 🌐 Python | 📅 2026-08-09 - Structured output extraction; useful with UI schemas for reliable generation.
...
* [Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 74,039 | 🐛 126 | 🌐 Python | 📅 2026-08-14 - Convert screenshots or designs to HTML/React/Vue code.
...
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,156 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-12 - Microsoft. MCP server for browser automation and UI regression testing workflows.
* [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 15,662 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-07 - GLips. Provides Figma layout information to AI coding agents.
* [Cursor Talk to Figma MCP](https://github.com/grab/cursor-talk-to-figma-mcp) ⭐ 6,966 | 🐛 87 | 🌐 JavaScript | 📅 2026-07-26 - Grab. MCP server + Figma plugin for reading and modifying Figma designs.
* [21st.dev Magic MCP](https://github.com/21st-dev/magic-mcp) ⭐ 5,665 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-31 - 21st.dev. Generate UI components from prompts with design-system awareness.
* [shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,934 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-16 - Jpisnice. Helps LLMs understand shadcn/ui component structure.
* [Storybook MCP](https://github.com/storybookjs/mcp) ⭐ 266 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-15 - Storybook. MCP server and addon that exposes component information and workflows from your local Storybook ([npm](https://www.npmjs.com/package/@storybook/mcp)).
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,306 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-15 - Widely used HTML sanitizer for untrusted/generated markup.
* [E2B](https://github.com/e2b-dev/e2b) ⭐ 13,413 | 🐛 44 | 🌐 Python | 📅 2026-08-13 - Sandboxed code execution environments for running untrusted generated code.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,257 | 🐛 498 | 🌐 TypeScript | 📅 2026-08-15 - Prompt and tool-call regression testing across models.
* [garak](https://github.com/NVIDIA/garak) ⭐ 8,813 | 🐛 382 | 🌐 Python | 📅 2026-08-14 - NVIDIA. LLM vulnerability scanner for automated probing.
...
* [Zod](https://github.com/colinhacks/zod) ⭐ 43,464 | 🐛 188 | 🌐 TypeScript | 📅 2026-08-15 - Colin Hacks. TypeScript schema validation for enforcing output shapes at runtime.
* [Guidance](https://github.com/guidance-ai/guidance) ⭐ 21,714 | 🐛 317 | 🌐 Jupyter Notebook | 📅 2026-05-21 - Grammar- and constraint-oriented prompting for structured outputs.
* [Outlines](https://github.com/dottxt-ai/outlines) ⭐ 15,625 | 🐛 155 | 🌐 Python | 📅 2026-08-15 - Structured generation with JSON/grammar constraints.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,888 | 🐛 0 | 🌐 Vue | 📅 2026-08-14 - Multi-framework streaming Markdown components for AI chat, with Mermaid, KaTeX, code highlighting, safe HTML, and SSR support.
...
* [ai-chatbot](https://github.com/vercel/ai-chatbot) ⭐ 20,827 | 🐛 24 | 🌐 TypeScript | 📅 2026-07-08 - Vercel. Full-featured chatbot with generative UI using the AI SDK.
* [morphic](https://github.com/miurla/morphic) ⭐ 9,043 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-15 - AI-powered search engine with generative answer UI.
...
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,179 | 🐛 225 | 🌐 Python | 📅 2026-04-14 - OpenAI. Framework for evaluating model outputs with custom tasks and graders.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,510 | 🐛 52 | 🌐 Python | 📅 2026-08-14 - TruEra. Evaluation and feedback tooling for LLM applications.
