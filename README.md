...
* [Model Context Protocol (MCP) Servers](https://github.com/modelcontextprotocol/servers) ⭐ 90,390 | 🐛 538 | 🌐 TypeScript | 📅 2026-09-03 - Reference implementations of MCP servers and tooling.
* [mcp-ui](https://github.com/idosal/mcp-ui) ⭐ 5,164 | 🐛 63 | 🌐 TypeScript | 📅 2026-07-08 - Ido Salomon and Liad Yosef. Community SDK (TypeScript, Ruby, Python) for serving interactive UI over MCP; pioneered the pattern that fed the official MCP Apps spec.
* [MCP Apps (UI Extension)](https://github.com/modelcontextprotocol/ext-apps) ⭐ 2,840 | 🐛 207 | 🌐 TypeScript | 📅 2026-09-16 - The official MCP extension for interactive UI: tools return UI resources that render in an iframe inside the host client. Builds on mcp-ui and the OpenAI Apps SDK ([announcement](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/)).
...
* [A2UI](https://github.com/google/a2ui) ⭐ 16,407 | 🐛 395 | 🌐 TypeScript | 📅 2026-09-16 - Google. Declarative, streaming (JSONL) generative-UI spec: agents request allow-listed components that the client renders natively (Flutter, Angular, Lit). A data format, not executable code ([site](https://a2ui.org/)).
* [AG-UI (Agent-User Interaction Protocol)](https://github.com/ag-ui-protocol/ag-ui) ⭐ 15,922 | 🐛 365 | 🌐 Python | 📅 2026-09-16 - CopilotKit. Open, event-based protocol that streams agent activity and shared state to front ends over SSE. Adopted by Google, LangChain, AWS, Microsoft, Mastra, and PydanticAI.
...
* [CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,383 | 🐛 291 | 🌐 TypeScript | 📅 2026-09-16 - Full-stack framework for in-app agents and generative UI across React, Angular, mobile, and Slack; makers of the AG-UI protocol.
* [assistant-ui](https://github.com/assistant-ui/assistant-ui) ⭐ 12,169 | 🐛 208 | 🌐 TypeScript | 📅 2026-09-16 - TypeScript/React primitives for AI chat with a first-class generative-UI primitive that renders agent-described components from a consumer-provided allowlist.
* [Tambo](https://github.com/tambo-ai/tambo) ⭐ 11,184 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-16 - Generative UI SDK for React, purpose-built for streaming AI-generated components.
* [OpenUI Lang (Thesys)](https://github.com/thesysdev/openui) ⭐ 9,447 | 🐛 162 | 🌐 TypeScript | 📅 2026-09-16 - MIT-licensed, streaming-first DSL and React runtime for model-generated UI; a compact, token-efficient alternative to emitting component JSON.
* [Hashbrown](https://github.com/liveloveapp/hashbrown) ⭐ 723 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-16 - Framework for building generative user interfaces in Angular and React.
...
* [Instructor](https://github.com/jxnl/instructor) ⭐ 13,908 | 🐛 62 | 🌐 Python | 📅 2026-09-11 - Structured output extraction; useful with UI schemas for reliable generation.
...
* [OpenUI (Weights & Biases)](https://github.com/wandb/openui) ⭐ 22,559 | 🐛 87 | 🌐 TypeScript | 📅 2026-09-10 - Describe UI in natural language and see it rendered live.
...
* [Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 79,051 | 🐛 145 | 🌐 Python | 📅 2026-09-09 - Convert screenshots or designs to HTML/React/Vue code.
...
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 37,179 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-14 - Microsoft. MCP server for browser automation and UI regression testing workflows.
...
* [21st.dev Magic MCP](https://github.com/21st-dev/magic-mcp) ⭐ 5,878 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-09 - 21st.dev. Generate UI components from prompts with design-system awareness.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,396 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-16 - Widely used HTML sanitizer for untrusted/generated markup.
* [E2B](https://github.com/e2b-dev/e2b) ⭐ 13,845 | 🐛 60 | 🌐 Python | 📅 2026-09-16 - Sandboxed code execution environments for running untrusted generated code.
* [Sandpack](https://github.com/codesandbox/sandpack) ⭐ 6,238 | 🐛 162 | 🌐 TypeScript | 📅 2025-04-24 - CodeSandbox. In-browser code sandboxing patterns for safe previews.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,186 | 🐛 632 | 🌐 TypeScript | 📅 2026-09-16 - Prompt and tool-call regression testing across models.
* [garak](https://github.com/NVIDIA/garak) ⭐ 9,270 | 🐛 437 | 🌐 Python | 📅 2026-09-09 - NVIDIA. LLM vulnerability scanner for automated probing.
...
* [Zod](https://github.com/colinhacks/zod) ⭐ 43,954 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-14 - Colin Hacks. TypeScript schema validation for enforcing output shapes at runtime.
* [Guidance](https://github.com/guidance-ai/guidance) ⭐ 21,755 | 🐛 327 | 🌐 Jupyter Notebook | 📅 2026-05-21 - Grammar- and constraint-oriented prompting for structured outputs.
* [Outlines](https://github.com/dottxt-ai/outlines) ⭐ 15,814 | 🐛 167 | 🌐 Python | 📅 2026-09-09 - Structured generation with JSON/grammar constraints.
...
* [GPT-Vis](https://github.com/antvis/GPT-Vis) ⭐ 781 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-16 - AntV. Visualization components designed for LLM-generated outputs.
...
* [ai-chatbot](https://github.com/vercel/ai-chatbot) ⭐ 20,947 | 🐛 28 | 🌐 TypeScript | 📅 2026-07-08 - Vercel. Full-featured chatbot with generative UI using the AI SDK.
* [morphic](https://github.com/miurla/morphic) ⭐ 9,123 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-16 - AI-powered search engine with generative answer UI.
...
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,469 | 🐛 340 | 🌐 Python | 📅 2026-04-14 - OpenAI. Framework for evaluating model outputs with custom tasks and graders.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,561 | 🐛 60 | 🌐 Python | 📅 2026-09-16 - TruEra. Evaluation and feedback tooling for LLM applications.
