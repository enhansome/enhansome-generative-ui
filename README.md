...
* [Model Context Protocol (MCP) Servers](https://github.com/modelcontextprotocol/servers) ⭐ 89,937 | 🐛 505 | 🌐 TypeScript | 📅 2026-08-28 - Reference implementations of MCP servers and tooling.
* [mcp-ui](https://github.com/idosal/mcp-ui) ⭐ 5,113 | 🐛 60 | 🌐 TypeScript | 📅 2026-07-08 - Ido Salomon and Liad Yosef. Community SDK (TypeScript, Ruby, Python) for serving interactive UI over MCP; pioneered the pattern that fed the official MCP Apps spec.
* [MCP Apps (UI Extension)](https://github.com/modelcontextprotocol/ext-apps) ⭐ 2,769 | 🐛 208 | 🌐 TypeScript | 📅 2026-08-12 - The official MCP extension for interactive UI: tools return UI resources that render in an iframe inside the host client. Builds on mcp-ui and the OpenAI Apps SDK ([announcement](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/)).
...
* [A2UI](https://github.com/google/a2ui) ⭐ 16,230 | 🐛 348 | 🌐 TypeScript | 📅 2026-08-29 - Google. Declarative, streaming (JSONL) generative-UI spec: agents request allow-listed components that the client renders natively (Flutter, Angular, Lit). A data format, not executable code ([site](https://a2ui.org/)).
* [AG-UI (Agent-User Interaction Protocol)](https://github.com/ag-ui-protocol/ag-ui) ⭐ 15,603 | 🐛 333 | 🌐 Python | 📅 2026-08-28 - CopilotKit. Open, event-based protocol that streams agent activity and shared state to front ends over SSE. Adopted by Google, LangChain, AWS, Microsoft, Mastra, and PydanticAI.
...
* [CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,094 | 🐛 373 | 🌐 TypeScript | 📅 2026-08-29 - Full-stack framework for in-app agents and generative UI across React, Angular, mobile, and Slack; makers of the AG-UI protocol.
* [assistant-ui](https://github.com/assistant-ui/assistant-ui) ⭐ 11,906 | 🐛 95 | 🌐 TypeScript | 📅 2026-08-29 - TypeScript/React primitives for AI chat with a first-class generative-UI primitive that renders agent-described components from a consumer-provided allowlist.
* [Tambo](https://github.com/tambo-ai/tambo) ⭐ 11,170 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-28 - Generative UI SDK for React, purpose-built for streaming AI-generated components.
* [OpenUI Lang (Thesys)](https://github.com/thesysdev/openui) ⭐ 8,480 | 🐛 144 | 🌐 TypeScript | 📅 2026-08-28 - MIT-licensed, streaming-first DSL and React runtime for model-generated UI; a compact, token-efficient alternative to emitting component JSON.
...
* [Instructor](https://github.com/jxnl/instructor) ⭐ 13,793 | 🐛 45 | 🌐 Python | 📅 2026-08-28 - Structured output extraction; useful with UI schemas for reliable generation.
...
* [Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 75,581 | 🐛 131 | 🌐 Python | 📅 2026-08-14 - Convert screenshots or designs to HTML/React/Vue code.
...
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,587 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-28 - Microsoft. MCP server for browser automation and UI regression testing workflows.
* [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 15,730 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-07 - GLips. Provides Figma layout information to AI coding agents.
...
* [21st.dev Magic MCP](https://github.com/21st-dev/magic-mcp) ⭐ 5,746 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-31 - 21st.dev. Generate UI components from prompts with design-system awareness.
* [shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,966 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-16 - Jpisnice. Helps LLMs understand shadcn/ui component structure.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,346 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-28 - Widely used HTML sanitizer for untrusted/generated markup.
* [E2B](https://github.com/e2b-dev/e2b) ⭐ 13,577 | 🐛 46 | 🌐 Python | 📅 2026-08-28 - Sandboxed code execution environments for running untrusted generated code.
* [Sandpack](https://github.com/codesandbox/sandpack) ⭐ 6,228 | 🐛 159 | 🌐 TypeScript | 📅 2025-04-24 - CodeSandbox. In-browser code sandboxing patterns for safe previews.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,650 | 🐛 540 | 🌐 TypeScript | 📅 2026-08-29 - Prompt and tool-call regression testing across models.
* [garak](https://github.com/NVIDIA/garak) ⭐ 9,066 | 🐛 408 | 🌐 Python | 📅 2026-08-25 - NVIDIA. LLM vulnerability scanner for automated probing.
...
* [Zod](https://github.com/colinhacks/zod) ⭐ 43,556 | 🐛 76 | 🌐 TypeScript | 📅 2026-08-29 - Colin Hacks. TypeScript schema validation for enforcing output shapes at runtime.
...
* [Outlines](https://github.com/dottxt-ai/outlines) ⭐ 15,708 | 🐛 163 | 🌐 Python | 📅 2026-08-28 - Structured generation with JSON/grammar constraints.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,969 | 🐛 3 | 🌐 Vue | 📅 2026-08-28 - Multi-framework streaming Markdown components for AI chat, with Mermaid, KaTeX, code highlighting, safe HTML, and SSR support.
...
* [ai-chatbot](https://github.com/vercel/ai-chatbot) ⭐ 20,885 | 🐛 28 | 🌐 TypeScript | 📅 2026-07-08 - Vercel. Full-featured chatbot with generative UI using the AI SDK.
* [morphic](https://github.com/miurla/morphic) ⭐ 9,069 | 🐛 59 | 🌐 TypeScript | 📅 2026-08-28 - AI-powered search engine with generative answer UI.
...
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,297 | 🐛 324 | 🌐 Python | 📅 2026-04-14 - OpenAI. Framework for evaluating model outputs with custom tasks and graders.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,526 | 🐛 60 | 🌐 Python | 📅 2026-08-28 - TruEra. Evaluation and feedback tooling for LLM applications.
