...
* [Mind2Web](https://github.com/OSU-NLP-Group/Mind2Web) ⭐ 1,028 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2025-11-05 - Dataset and benchmark for generalist web agents grounded in real webpages.
...
* [Model Context Protocol (MCP) Servers](https://github.com/modelcontextprotocol/servers) ⭐ 90,501 | 🐛 550 | 🌐 TypeScript | 📅 2026-09-03 - Reference implementations of MCP servers and tooling.
* [mcp-ui](https://github.com/idosal/mcp-ui) ⭐ 5,168 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-16 - Ido Salomon and Liad Yosef. Community SDK (TypeScript, Ruby, Python) for serving interactive UI over MCP; pioneered the pattern that fed the official MCP Apps spec.
* [MCP Apps (UI Extension)](https://github.com/modelcontextprotocol/ext-apps) ⭐ 2,859 | 🐛 211 | 🌐 TypeScript | 📅 2026-09-16 - The official MCP extension for interactive UI: tools return UI resources that render in an iframe inside the host client. Builds on mcp-ui and the OpenAI Apps SDK ([announcement](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/)).
...
* [A2UI](https://github.com/google/a2ui) ⭐ 16,449 | 🐛 406 | 🌐 TypeScript | 📅 2026-09-19 - Google. Declarative, streaming (JSONL) generative-UI spec: agents request allow-listed components that the client renders natively (Flutter, Angular, Lit). A data format, not executable code ([site](https://a2ui.org/)).
* [AG-UI (Agent-User Interaction Protocol)](https://github.com/ag-ui-protocol/ag-ui) ⭐ 15,959 | 🐛 379 | 🌐 TypeScript | 📅 2026-09-19 - CopilotKit. Open, event-based protocol that streams agent activity and shared state to front ends over SSE. Adopted by Google, LangChain, AWS, Microsoft, Mastra, and PydanticAI.
...
* [CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,432 | 🐛 287 | 🌐 TypeScript | 📅 2026-09-20 - Full-stack framework for in-app agents and generative UI across React, Angular, mobile, and Slack; makers of the AG-UI protocol.
* [assistant-ui](https://github.com/assistant-ui/assistant-ui) ⭐ 12,225 | 🐛 169 | 🌐 TypeScript | 📅 2026-09-20 - TypeScript/React primitives for AI chat with a first-class generative-UI primitive that renders agent-described components from a consumer-provided allowlist.
* [Tambo](https://github.com/tambo-ai/tambo) ⭐ 11,182 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-17 - Generative UI SDK for React, purpose-built for streaming AI-generated components.
* [OpenUI Lang (Thesys)](https://github.com/thesysdev/openui) ⭐ 9,763 | 🐛 152 | 🌐 TypeScript | 📅 2026-09-20 - MIT-licensed, streaming-first DSL and React runtime for model-generated UI; a compact, token-efficient alternative to emitting component JSON.
* [Hashbrown](https://github.com/liveloveapp/hashbrown) ⭐ 723 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-20 - Framework for building generative user interfaces in Angular and React.
* [mdocUI](https://github.com/mdocui/mdocui) ⭐ 39 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-19 - Streaming generative UI using Markdoc `{% %}` tag syntax. Framework-agnostic core with React renderer, 24 theme-neutral components, and Zod schema validation.
...
* [Mitosis](https://github.com/BuilderIO/mitosis) ⭐ 14,403 | 🐛 176 | 🌐 TypeScript | 📅 2026-07-21 - Builder.io. Write components once and compile to React/Vue/Svelte/etc.
* [Instructor](https://github.com/jxnl/instructor) ⭐ 13,926 | 🐛 73 | 🌐 Python | 📅 2026-09-18 - Structured output extraction; useful with UI schemas for reliable generation.
...
* [OpenUI (Weights & Biases)](https://github.com/wandb/openui) ⭐ 22,563 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-19 - Describe UI in natural language and see it rendered live.
* [openv0](https://github.com/raidendotai/openv0) ⭐ 3,956 | 🐛 34 | 🌐 TypeScript | 📅 2024-09-19 - Open source v0 clone that generates React/Tailwind components from prompts.
...
* [Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 79,403 | 🐛 146 | 🌐 Python | 📅 2026-09-09 - Convert screenshots or designs to HTML/React/Vue code.
...
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 37,397 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-18 - Microsoft. MCP server for browser automation and UI regression testing workflows.
* [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 15,882 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-18 - GLips. Provides Figma layout information to AI coding agents.
* [Cursor Talk to Figma MCP](https://github.com/grab/cursor-talk-to-figma-mcp) ⭐ 7,029 | 🐛 90 | 🌐 JavaScript | 📅 2026-07-26 - Grab. MCP server + Figma plugin for reading and modifying Figma designs.
* [21st.dev Magic MCP](https://github.com/21st-dev/magic-mcp) ⭐ 5,901 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-09 - 21st.dev. Generate UI components from prompts with design-system awareness.
* [shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,999 | 🐛 5 | 🌐 TypeScript | 📅 2026-05-16 - Jpisnice. Helps LLMs understand shadcn/ui component structure.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,410 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-19 - Widely used HTML sanitizer for untrusted/generated markup.
* [E2B](https://github.com/e2b-dev/e2b) ⭐ 13,893 | 🐛 72 | 🌐 Python | 📅 2026-09-19 - Sandboxed code execution environments for running untrusted generated code.
* [Sandpack](https://github.com/codesandbox/sandpack) ⭐ 6,242 | 🐛 163 | 🌐 TypeScript | 📅 2025-04-24 - CodeSandbox. In-browser code sandboxing patterns for safe previews.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,313 | 🐛 636 | 🌐 TypeScript | 📅 2026-09-20 - Prompt and tool-call regression testing across models.
* [garak](https://github.com/NVIDIA/garak) ⭐ 9,315 | 🐛 450 | 🌐 Python | 📅 2026-09-16 - NVIDIA. LLM vulnerability scanner for automated probing.
...
* [Zod](https://github.com/colinhacks/zod) ⭐ 43,981 | 🐛 66 | 🌐 TypeScript | 📅 2026-09-19 - Colin Hacks. TypeScript schema validation for enforcing output shapes at runtime.
* [Guidance](https://github.com/guidance-ai/guidance) ⭐ 21,767 | 🐛 326 | 🌐 Jupyter Notebook | 📅 2026-05-21 - Grammar- and constraint-oriented prompting for structured outputs.
* [Outlines](https://github.com/dottxt-ai/outlines) ⭐ 15,843 | 🐛 173 | 🌐 Python | 📅 2026-09-19 - Structured generation with JSON/grammar constraints.
...
* [LangUI](https://github.com/LangbaseInc/langui) ⭐ 3,145 | 🐛 6 | 🌐 HTML | 📅 2024-07-10 - LangbaseInc. Tailwind components for chat, AI assistants, and LLM projects.
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 3,014 | 🐛 3 | 🌐 Vue | 📅 2026-09-13 - Multi-framework streaming Markdown components for AI chat, with Mermaid, KaTeX, code highlighting, safe HTML, and SSR support.
* [GPT-Vis](https://github.com/antvis/GPT-Vis) ⭐ 782 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-17 - AntV. Visualization components designed for LLM-generated outputs.
...
* [ai-chatbot](https://github.com/vercel/ai-chatbot) ⭐ 20,959 | 🐛 28 | 🌐 TypeScript | 📅 2026-07-08 - Vercel. Full-featured chatbot with generative UI using the AI SDK.
* [morphic](https://github.com/miurla/morphic) ⭐ 9,133 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-20 - AI-powered search engine with generative answer UI.
...
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,486 | 🐛 340 | 🌐 Python | 📅 2026-04-14 - OpenAI. Framework for evaluating model outputs with custom tasks and graders.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,566 | 🐛 71 | 🌐 Python | 📅 2026-09-18 - TruEra. Evaluation and feedback tooling for LLM applications.
